...
HP3a = get_hierarchical_partition(fit$posterior, omega = 'dich', lambda = 'coda.norm')
...
HP5b = get_hierarchical_partition(fit$posterior, f_omega = f_omega2, f_lambda = f_lambda)
...
ggsave(filename = 'figures/multinomial_Svalues_all.pdf', height = 5, width=10)
